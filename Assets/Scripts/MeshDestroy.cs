 ...
 *  Made by: Eli
 *  
 *  I wont pretend to know how the math works for recalculating the mesh's triangles vertices or normals. However,
 *  Go to line ~330 for the best place to add things to the gameobjects that get created after the mesh is broken
 * https://gist.github.com/ditzel/73f4d1c9028cc3477bb921974f84ed56#file-meshdestroy-cs-L6
 */
...
public class MeshDestroy : MonoBehaviour
{
    ...
    /// </summary>
    public void MarkThisGameObjectForRemoval()
    {
    ...
    {
        float time = 0;
        DyingPieceLifetime += Random.Range(0f, 3f); //some variation
        while (time < DyingPieceLifetime)
        {
            time += Time.deltaTime;
            yield return null;
        }
    ...
    /// <summary>
    /// DANGER!!! BE CAREFUL UTILIZING THIS METHOD. REPEATED CALLS WILL CRASH UNITY
    /// </summary>
    public void DestroyMesh()
    {
        ...
        for (var i = 0; i < parts.Count; i++)
        {
            ...
            {
                go.GetComponent<MeshDestroy>().MarkThisGameObjectForRemoval();
            }
            //print(go.name + " " + volume);
        }
